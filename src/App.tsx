      ...
      <div className="min-h-screen bg-gray-50">
        <nav className="bg-slate-900 text-white p-4">
          <div className="container mx-auto flex gap-6">
            <span className="font-bold text-xl">MySports</span>
            <a href="/nhl" className="hover:text-gray-300">NHL</a>
            <span className="text-gray-500 cursor-not-allowed">NBA (Coming Soon)</span>
          </div>
        </nav>
